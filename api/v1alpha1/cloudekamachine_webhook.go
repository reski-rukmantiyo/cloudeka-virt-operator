...
var cloudekamachinelog = logf.Log.WithName("cloudekamachine-resource")

// SetupWebhookWithManager will setup the manager to manage the webhooks
func (r *CloudekaMachine) SetupWebhookWithManager(mgr ctrl.Manager) error {
...
func (r *CloudekaMachine) Default() {
	cloudekamachinelog.Info("default", "name", r.Name)
...
func (r *CloudekaMachine) ValidateCreate() (admission.Warnings, error) {
	cloudekamachinelog.Info("validate create", "name", r.Name)
...
func (r *CloudekaMachine) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
	cloudekamachinelog.Info("validate update", "name", r.Name)
...
func (r *CloudekaMachine) ValidateDelete() (admission.Warnings, error) {
	cloudekamachinelog.Info("validate delete", "name", r.Name)
